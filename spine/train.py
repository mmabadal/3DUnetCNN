...
config["image_shape"] = (128, 128, 384)  # This determines what shape the images will be cropped/resampled to.
...
config["model_file"] = os.path.abspath("segmentation_model.h5")
